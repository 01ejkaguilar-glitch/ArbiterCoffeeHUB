...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Available Settings: "default", "routes", "paths", "scanOptions", "securityDefinitions"
    | Also check l5-swagger defaults
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure one or more API documentations
    |
    */
    ...
    'documentations' => [
        ...
        'default' => [
            ...
            'api' => [
                ...
                'title' => 'Arbiter Coffee Hub API',
                'description' => 'API for Arbiter Coffee Hub - A specialty coffee e-commerce platform',
                'version' => '1.0.0',
                'termsOfService' => '',
                'contact' => [
            ...
            |--------------------------------------------------------------------------
            |
            | Configure routes for accessing the API documentation
            |
            */
            ...
            |--------------------------------------------------------------------------
            |
            | Configure paths for swagger assets and documentation files
            |
            */
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            'default_processors_configuration' => [
                // Example processors configuration
            ],
             ...
             *   ['class' => MyProcessor::class, 'after' => \OpenApi\Processors\AugmentSchemas::class],
             *
        ...
        */
        'securityDefinitions' => [
            ...
            'security' => [
                [ // Example of applying security to all endpoints
                    'sanctum' => []
                ],
            ],
        ],
